...
var reviewL2 = 0
var reviewL3 = 0
var scoreCard = 2 // scans array for all win spaces and counts up. Starts at 2 to match default map
        ...
        for (var i = 0; i < globalMap.length; i++) {
            ...
            for (var j = 0; j < globalMap[i].length; j++) {
                ...
                if (globalMap[i][j] == 'purple') {
				  ...
				  else if (globalMap[i][j] == '') {
                    $(image).attr('src', 'pitch.jpg', )
                }
...
playerPosition = [playerPosition[0], playerPosition[1]];
	...
	//stops boxes getting stuck in walls
	...
	//turns boxes into win condition
	...
	//stops boxes going into each other
	...
	//stops boxes being pushed into win conditions
	
		if (globalMap[playerPosition[0]][playerPosition[1]-1] === "yellow" && globalMap[playerPosition[0]][playerPosition[1]] === "box1" && 37 === window.event.which) {
		playerPosition[1] = playerPosition[1] + 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "box1"
		globalMap[playerPosition[0]][playerPosition[1]-1]= "yellow"
    }	
	if (globalMap[playerPosition[0]-1][playerPosition[1]] === "yellow" && globalMap[playerPosition[0]][playerPosition[1]] === "box1" && 38 === window.event.which) {
		playerPosition[0] = playerPosition[0] + 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "box1"
		globalMap[playerPosition[0]-1][playerPosition[1]]= "yellow"
    }	
	if (globalMap[playerPosition[0]][playerPosition[1]+1] === "yellow" && globalMap[playerPosition[0]][playerPosition[1]] === "box1" && 39 === window.event.which) {
		playerPosition[1] = playerPosition[1] - 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "box1"
		globalMap[playerPosition[0]][playerPosition[1]+1]= "yellow"
    }	
	if (globalMap[playerPosition[0]+1][playerPosition[1]] === "yellow" && globalMap[playerPosition[0]][playerPosition[1]] === "box1" && 40 === window.event.which) {
		playerPosition[0] = playerPosition[0] - 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "box1"
		globalMap[playerPosition[0]+1][playerPosition[1]]= "yellow"
    }	
	
	//stops win conditions being pushed onto boxes
	
		
	if (globalMap[playerPosition[0]][playerPosition[1]-1] === "box1" && globalMap[playerPosition[0]][playerPosition[1]] === "yellow" && 37 === window.event.which) {
		playerPosition[1] = playerPosition[1] + 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "purple"
		globalMap[playerPosition[0]][playerPosition[1]-1]= "yellow"
    }	
	if (globalMap[playerPosition[0]-1][playerPosition[1]] === "box1" && globalMap[playerPosition[0]][playerPosition[1]] === "yellow" && 38 === window.event.which) {
		playerPosition[0] = playerPosition[0] + 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "purple"
		globalMap[playerPosition[0]-1][playerPosition[1]]= "yellow"
    }	
	if (globalMap[playerPosition[0]][playerPosition[1]+1] === "box1" && globalMap[playerPosition[0]][playerPosition[1]] === "yellow" && 39 === window.event.which) {
		playerPosition[1] = playerPosition[1] - 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "purple"
		globalMap[playerPosition[0]][playerPosition[1]+1]= "yellow"
    }	
	if (globalMap[playerPosition[0]+1][playerPosition[1]] === "box1" && globalMap[playerPosition[0]][playerPosition[1]] === "yellow" && 40 === window.event.which) {
		playerPosition[0] = playerPosition[0] - 1;
		globalMap[playerPosition[0]][playerPosition[1]]= "purple"
		globalMap[playerPosition[0]+1][playerPosition[1]]= "yellow"
    }	
	
	//stops you piushing win boxes through walls
...
function undo(event) {
    ...
    $("#change").click(function() {
        if (37 === lastMove) {
			...
			//just incase your on black while undoing move onto yellow space
	if (37 === lastMove && globalMap[playerPosition[0]][playerPosition[1]-2] === "box1" && globalMap[playerPosition[0]][playerPosition[1]-1] === "black" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
        globalMap[playerPosition[0]][playerPosition[1]-1]= "yellow"
		globalMap[playerPosition[0]][playerPosition[1]-2]= "purple"
		goodSpace++
    }
	if (38 === lastMove && globalMap[playerPosition[0]-2][playerPosition[1]] === "box1" && globalMap[playerPosition[0]-1][playerPosition[1]] === "black"  /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
        globalMap[playerPosition[0]-1][playerPosition[1]]= "yellow"
		globalMap[playerPosition[0]-2][playerPosition[1]]= "purple"
		goodSpace++
    }
	if ( 39 === lastMove && globalMap[playerPosition[0]][playerPosition[1]+2] === "box1" && globalMap[playerPosition[0]][playerPosition[1]+1] === "black"  /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
        globalMap[playerPosition[0]][playerPosition[1]+1]= "yellow"
		globalMap[playerPosition[0]][playerPosition[1]+2]= "purple"
		goodSpace++
    }
	
	if (40 === lastMove && globalMap[playerPosition[0]+2][playerPosition[1]] === "box1" && globalMap[playerPosition[0]+1][playerPosition[1]] === "black" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
        globalMap[playerPosition[0]+1][playerPosition[1]]= "yellow"
		globalMap[playerPosition[0]+2][playerPosition[1]]= "purple"
		goodSpace++
    }
	...
	//undo back onto a win space with a barrel		
	...
	if (40 === lastMove && globalMap[playerPosition[0]+2][playerPosition[1]] === "yellow" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
		...
		//stop undoing into wall
	if (37 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "pink" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[1]]=  [playerPosition[1]-1]
    }
	if (38 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "pink" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/ ) {
 		[playerPosition[0]]=  [playerPosition[0]-1]
    }
	if (39 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "pink" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[1]]=  [playerPosition[1]+1]
    }
	
	if (40 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "pink" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[0]]=  [playerPosition[0]+1]
    }	
//stop undoing into Boxes
		
	if (37 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "box1" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[1]]=  [playerPosition[1]-1]
    }
	if (38 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "box1" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/ ) {
 		[playerPosition[0]]=  [playerPosition[0]-1]
    }
	if (39 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "box1" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[1]]=  [playerPosition[1]+1]
    }
	
	if (40 === lastMove && globalMap[playerPosition[0]][playerPosition[1]] === "box1" /*&& globalMap[1][2] === "box1"*/ /*&& gamesWon == 0*/ /*&& globalMap[1][1] !== "box2"*/) {
 		[playerPosition[0]]=  [playerPosition[0]+1]
    }
